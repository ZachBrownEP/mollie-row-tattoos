      ...
      <section className="relative py-16 lg:py-24 overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">Showcasing the artistry and craftsmanship that defines Sol De Noche Tatuajes</p>
          </div>
        </div>
      </section>
          ...
          >
            ...
            <div className="bg-card rounded-lg overflow-hidden shadow-2xl">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">Expert artistry by Maureen Orrissim at Sol De Noche Tatuajes</p>
