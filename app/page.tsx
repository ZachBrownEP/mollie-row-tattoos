                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Phone: (512) 555-0123
                      <br />
                      Email: info@soldenochetatuajes.com
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-4">
            <div>
              ...
              <p className="mb-4">Portland, OR</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="mb-2">2505 SE 11TH Portland, OR</p>
              ...
              <div className="space-y-2">
                ...
                <a href="https://www.instagram.com/sol.de.noche.tattoo/" target="_blank" rel="noopener noreferrer" className="block text-primary hover:underline">
          ...
          <div className="mt-8 border-t border-neutral-800 pt-8 text-center text-sm">
            <p>&copy; {new Date().getFullYear()} Sol De Noche Tatuajes. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
