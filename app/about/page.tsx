      ...
      <section className="bg-black py-20 text-white">
        <div className="container px-4 md:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg">The story behind Yuyuicy Ink</p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-12 text-center">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground">
                At Yuyuicy Ink, we believe that tattoos are more than just body art—they're personal
                stories, memories, and expressions of identity. Located in the vibrant heart of Chicago, we've been
            ...
            <div className="mb-12">
              ...
              <div className="prose max-w-none text-muted-foreground">
                <p className="mb-4">
                  Founded in 2018 by a collective of passionate tattoo artists, Yuyuicy Ink was born from
            ...
            <div className="text-center">
              ...
              <p className="mb-6 text-muted-foreground">
                Book your consultation today and discover why we're Chicago's premier tattoo studio.
              </p>
