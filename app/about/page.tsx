      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground leading-relaxed mobile-safe">The story behind Sol De Noche Tatuajes</p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="mb-16 text-center">
              ...
              <p className="text-sm sm:text-base lg:text-lg xl:text-xl leading-relaxed text-muted-foreground max-w-3xl mx-auto mobile-safe">
                At Sol De Noche Tatuajes, we believe that tattoos are more than just body art—they're personal
                stories, memories, and expressions of identity. Located in the vibrant heart of Portland, we've been
            ...
            <div className="mb-16">
              ...
              <div className="max-w-3xl mx-auto space-y-6 text-muted-foreground text-lg leading-relaxed">
                <p>
                  Founded by Maureen Orrissim, Sol De Noche Tatuajes was born from
                ...
                <p>
                  Maureen brings diverse experience and specialties, from photorealistic portraits to bold
            ...
            <div className="text-center">
              ...
              <p className="mb-8 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Book your consultation today and discover why we're Portland's premier tattoo studio.
              </p>
